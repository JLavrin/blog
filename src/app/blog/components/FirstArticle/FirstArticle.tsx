...
export default function FirstArticle({ data }: Props) {
  ...
  return (
    <Link href={`/blog/${data.slug}`}>
      ...
      <div className="items-end cursor-pointer hidden container relative mx-auto p-4 md:flex min-h-[240px] md:min-h-[720px] rounded-2xl overflow-hidden">
        <div className="z-0">
        ...
        <div className="relative z-10 flex flex-col items-start gap-y-4 p-4 md:p-8 w-full">
          <div className="flex justify-between w-full text-white">
            ...
            <div>"emote of arrow poiting to right top corner"</div>
          </div>
